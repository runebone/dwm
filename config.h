...
static char selbordercolor[]        = "#268db2";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_z,		spawn,		SHCMD("obsidian") }, // XXX (my modification)
	...
	{ MODKEY,			XK_F11,		spawn,		SHCMD("mpv --vf=hflip --no-cache --no-osc --no-input-default-bindings --input-conf=/dev/null --profile=low-latency --title=webcam $(ls /dev/video0)") },
